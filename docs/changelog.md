...
- Prepared the Community mainline around the retained local core workflows: Dashboard, Rules, Skills, Config, MCP, and Settings.
- Removed public exposure for advanced workflows that are not part of the first Community release.
